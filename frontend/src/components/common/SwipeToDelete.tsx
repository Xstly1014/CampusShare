...
export default function SwipeToDelete({ onDelete, children, isOpen, onOpenChange }: SwipeToDeleteProps) {
  ...
  const translateX = draggingRef.current ? dragX : (isOpen ? -DELETE_WIDTH : 0)
