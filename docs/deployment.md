...
| 服务 | 容器内端口 | 宿主机端口 | 说明 |
|------|-----------|-----------|------|
| campusshare-frontend | 80 | 80 | 前端 H5 页面 |
| campusshare-gateway | 8080 | 8080 | API 网关 |
| campusshare-user | 8081 | 8081 | 用户服务 |
| MySQL | 3306 | 3306 | 数据库 |
| Redis | 6379 | 6379 | 缓存 |
| **Prometheus** | 9090 | 9090 | **监控指标采集** |
| **Grafana** | 3000 | 3000 | **可视化仪表盘** |
| **Tempo** | 3200 / 4317 / 4318 | 3200 / 4317 / 4318 | **链路追踪** |

### 1.3 可观测性三支柱

| 支柱 | 工具 | 作用 | 访问地址 |
|------|------|------|---------|
| **Metrics (指标)** | Prometheus + Grafana | QPS、延迟、错误率、JVM、资源使用率 | http://服务器IP:3000 |
| **Traces (链路)** | OpenTelemetry + Tempo + Grafana | 请求全链路追踪、慢调用定位 | http://服务器IP:3000 (Explore → Tempo) |
| **Logs (日志)** | (待接入 ELK/Loki) | 日志聚合、错误排查 | - |
